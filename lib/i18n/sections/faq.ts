  ...
  en: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "WeChat Pay settlements are processed on a T+1 basis — funds from transactions completed today are typically deposited to your registered Canadian bank account the next business day.",
      },
      {
        q: "Do I need special hardware?",
        a: "For in-store payments, you simply display a static WeChat Pay QR code — no special terminal required. For businesses that want a dynamic QR or integration with their POS system, we can help set that up as part of onboarding.",
      },
      {
        q: "What types of businesses are supported?",
        a: "We support a wide range of business types: retail stores, restaurants and cafes, professional services, health and wellness, tourism, e-commerce, and more. If you serve or want to serve Chinese-speaking customers, WeChat Pay is a natural fit.",
      },
      {
      ...
      },
      {
        ...
        a: "Reach out via the contact form below or send us an email. We'll schedule a quick call, answer your questions, and walk you through the application — usually within one business day.",
      },
    ],
  },
  zh: {
    ...
    items: [
      ...
      {
        q: "结算 / 提款是如何运作的？",
        a: "微信支付采用 T+1 结算机制 —— 今日完成的交易款项，通常于下一个工作日划入您的加拿大注册银行账户。",
      },
      {
        q: "我需要特殊硬件设备吗？",
        a: "线下收款只需展示一张静态微信支付收款码，无需任何专用终端设备。若您希望使用动态收款码或与 POS 系统集成，我们可在开通阶段协助您完成配置。",
      },
      {
        q: "支持哪些类型的商家？",
        a: "我们支持多种类型的商家：零售门店、餐厅与咖啡厅、专业服务机构、健康与美容行业、旅游业、电子商务等。只要您服务或希望吸引华人消费者，微信支付都是理想之选。",
      },
      {
      ...
      {
        q: "我该如何开始？",
        a: "请通过下方联系表单或发送电子邮件与我们取得联系。我们将安排一次简短通话，解答您的疑问并引导您完成申请 —— 通常在一个工作日内即可办理。",
      },
    ],
  },
} as const;
